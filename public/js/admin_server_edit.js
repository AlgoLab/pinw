...
$(document).ready(function() {
    ...
    $("#InputCallback").click(function(){
        if($(this).is(":checked")) {
            ...
            $('#editServerForm').bootstrapValidator('enableFieldValidators', 'InputCallbackURL', true);
        } else {
            $('#InputCallbackURL').val("");
            $('#rowInputCallbackURL').addClass('hide');
            $('#editServerForm').bootstrapValidator('enableFieldValidators', 'InputCallbackURL', false);
        }
    });
    ...
    $("#submitTest").click(function(){
        ...
        $("#editServerForm")
            ...
            .on('success.form.bv', function(e) {
                ...
                $("#editServerForm").off('success.form.bv');
                return false;
            });
    });
